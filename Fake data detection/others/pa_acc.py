# -*- coding: utf-8 -*-
"""
Created on Fri Sep 20 08:36:49 2019
...
for total_batch in range(0,10001,50):
    ...
    for test_index, test_elm in enumerate(test_sentences):
        ...
        pos_corr = pos_cor_1_pd.corr(pos_cor_2_pd)
        neg_corr = neg_cor_1_pd.corr(neg_cor_2_pd)
        if  abs(neg_corr-neg_mean_cor)<=abs(neg_corr-neg_mean_cor2): #and neg_corr<=neg_mean_cor:#
...
with open('./save/riasec/acc_result/pa_acc.txt', 'w') as f:
